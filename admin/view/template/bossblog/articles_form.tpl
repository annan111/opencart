		...
		<div class="tab-content">
              ...
              <ul class="nav nav-tabs" id="language">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="article_description[<?php echo $language['language_id']; ?>][content]" placeholder="<?php echo $entry_content; ?>" id="input-description<?php echo $language['language_id']; ?>" class="summernote"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['content'] : ''; ?></textarea>
                    </div>
                  </div>                  
			...
			<div class="tab-pane" id="tab-meta">
              <ul class="nav nav-tabs" id="language-meta">
                <?php foreach ($languages as $language) { ?>
                <li><a href="#language-meta<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
				<div class="tab-content">
                <?php foreach ($languages as $language) { ?>
