              ...
              <div class="block_relative">
                <div id="module_list" class="module_list" data-text-confirm="<?php echo $text_confirm;?>" data-text-edit="<?php echo $text_edit_module;?>">
                  <div class="heading-bar"><?php echo $text_module_list;?>
                    <div class="btn-group pull-right"> <a class="btn" onclick="Layout.refresh_module_list()" data-toggle="tooltip" title="<?php echo 'Refresh Installed Modules'; ?>" target="_blank"><i class="fa fa-refresh"></i></a> <a class="btn" href="<?php echo $module_manager; ?>" data-toggle="tooltip" title="<?php echo $text_all_module; ?>" target="_blank"><i class="fa fa-external-link"></i></a> </div>
                  </div>
                  <div class="bt-module-accordion bt-accordion">
                    ...
                    <div class="ds_content bt-drag">
                      ...
                      <div class="module-block" data-code="<?php echo $module['code']; ?>"> <i class="fa fa-puzzle-piece bt-enable"></i> <?php echo strip_tags($module['name']); ?> <a class="btn btn-sm btn-edit" href="<?php echo $module['edit']; ?>"><i class="fa fa-edit" data-toggle="tooltip" title="<?php echo $text_edit_module;?>"></i></a> </div>
                      <?php } ?>
                    </div>
                    <?php } ?>
                  </div>
                ...
                <div class="container-fluid">
                  <div class="row colsliders">
                    <div class="col-md-12 position sidebar_column bt-left">
                      <div class="dashed bt-placeholder" data-position="header_top" data-placeholder="<?php echo $text_header_top; ?>">
                        <?php $module_row = 0; ?>
                        ...
                        <div class="mblock" data-code="<?php echo $layout_module['code'];?>">
                          ...
                          <div class="btn-group"> <a class="btn btn-xs btn-edit" href="<?php echo $layout_module['href']; ?>"><?php echo $text_edit_module; ?></a> <a class="btn btn-xs btn-remove" onclick="confirm('<?php echo addslashes($text_confirm); ?>')?$(this).parents('.mblock').remove():false;">Remove</a> </div>
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][code]" value="<?php echo $layout_module['code']; ?>">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][position]" class="layout_position" value="header_top">
                    ...
                    <div class="col-md-12 position sidebar_column bt-left">
                      <div class="dashed bt-placeholder" data-position="header_menu" data-placeholder="<?php echo $text_header_menu; ?>">
                        <?php $module_row = 0; ?>
                        <?php foreach ($layout_modules as $layout_module) { ?>
                        ...
                        <div class="mblock" data-code="<?php echo $layout_module['code'];?>">
                          ...
                          <div class="btn-group"> <a class="btn btn-xs btn-edit" href="<?php echo $layout_module['href']; ?>"><?php echo $text_edit_module; ?></a> <a class="btn btn-xs btn-remove" onclick="confirm('<?php echo addslashes($text_confirm); ?>')?$(this).parents('.mblock').remove():false;">Remove</a> </div>
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][code]" value="<?php echo $layout_module['code']; ?>">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][position]" class="layout_position" value="header_menu">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $layout_module['sort_order']; ?>" class="sort">
                        </div>
                        <?php } ?>
                        <?php $module_row++; ?>
                    ...
                    <div class="col-md-12 position sidebar_column bt-left">
                      <div class="dashed bt-placeholder" data-position="header_bottom" data-placeholder="<?php echo $text_header_bottom; ?>">
                        <?php $module_row = 0; ?>
                        <?php foreach ($layout_modules as $layout_module) { ?>
                        ...
                        <div class="mblock" data-code="<?php echo $layout_module['code'];?>">
                          ...
                          <div class="btn-group"> <a class="btn btn-xs btn-edit" href="<?php echo $layout_module['href']; ?>"><?php echo $text_edit_module; ?></a> <a class="btn btn-xs btn-remove" onclick="confirm('<?php echo addslashes($text_confirm); ?>')?$(this).parents('.mblock').remove():false;">Remove</a> </div>
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][code]" value="<?php echo $layout_module['code']; ?>">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][position]" class="layout_position" value="header_bottom">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $layout_module['sort_order']; ?>" class="sort">
                        </div>
                        <?php } ?>
                        <?php $module_row++; ?>
                  ...
                  <div class="row colsliders bt-footer">
                    <div class="col-md-12 position sidebar_column bt-left">
                      <div class="dashed bt-placeholder" data-position="footer_top" data-placeholder="<?php echo $text_footer_top; ?>">
                        <?php $module_row = 0; ?>
                        <?php foreach ($layout_modules as $layout_module) { ?>
                        ...
                        <div class="mblock" data-code="<?php echo $layout_module['code'];?>">
                          ...
                          <div class="btn-group"> <a class="btn btn-xs btn-edit" href="<?php echo $layout_module['href']; ?>"><?php echo $text_edit_module; ?></a> <a class="btn btn-xs btn-remove" onclick="confirm('<?php echo addslashes($text_confirm); ?>')?$(this).parents('.mblock').remove():false;">Remove</a> </div>
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][code]" value="<?php echo $layout_module['code']; ?>">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][position]" class="layout_position" value="footer_top">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $layout_module['sort_order']; ?>" class="sort">
                        </div>
                        <?php } ?>
                        <?php $module_row++; ?>
                    ...
                    <div class="col-md-6 position sidebar_column bt-left">
                      <div class="dashed bt-placeholder" data-position="footer_first" data-placeholder="<?php echo $text_footer_first; ?>">
                        <?php $module_row = 0; ?>
                        <?php foreach ($layout_modules as $layout_module) { ?>
                        ...
                        <div class="mblock" data-code="<?php echo $layout_module['code'];?>">
                          ...
                          <div class="btn-group"> <a class="btn btn-xs btn-edit" href="<?php echo $layout_module['href']; ?>"><?php echo $text_edit_module; ?></a> <a class="btn btn-xs btn-remove" onclick="confirm('<?php echo addslashes($text_confirm); ?>')?$(this).parents('.mblock').remove():false;">Remove</a> </div>
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][code]" value="<?php echo $layout_module['code']; ?>">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][position]" class="layout_position" value="footer_first">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $layout_module['sort_order']; ?>" class="sort">
                        </div>
                        <?php } ?>
                        <?php $module_row++; ?>
                    ...
                    <div class="col-md-6 position sidebar_column bt-left">
                      <div class="dashed bt-placeholder" data-position="footer_second" data-placeholder="<?php echo $text_footer_second; ?>">
                        <?php $module_row = 0; ?>
                        <?php foreach ($layout_modules as $layout_module) { ?>
                        ...
                        <div class="mblock" data-code="<?php echo $layout_module['code'];?>">
                          ...
                          <div class="btn-group"> <a class="btn btn-xs btn-edit" href="<?php echo $layout_module['href']; ?>"><?php echo $text_edit_module; ?></a> <a class="btn btn-xs btn-remove" onclick="confirm('<?php echo addslashes($text_confirm); ?>')?$(this).parents('.mblock').remove():false;">Remove</a> </div>
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][code]" value="<?php echo $layout_module['code']; ?>">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][position]" class="layout_position" value="footer_second">
                          <input type="hidden" name="layout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $layout_module['sort_order']; ?>" class="sort">
                        </div>
                        <?php } ?>
                        <?php $module_row++; ?>
