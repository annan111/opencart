    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-show_slider"><?php echo $entry_scrolling; ?></label>
            <div class="col-sm-10">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-show_slider"><?php echo $entry_use_slider; ?></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-num-row"><?php echo $entry_num_row; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="num_row" value="<?php echo isset($num_row)?$num_row:1; ?>" placeholder="<?php echo $entry_num_row; ?>" id="input-num-row" class="form-control" />
                  <?php if ($error_num_row) { ?>
                  <div class="text-danger"><?php echo $error_num_row; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="per_row" value="<?php echo isset($per_row)?$per_row:3; ?>" placeholder="<?php echo $entry_per_row; ?>" id="input-per-row" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="column" id="input-column" class="form-control">
                <?php foreach ($column_values as $value => $name) { ?>
                <option value="<?php echo $value; ?>" <?php echo ($column == $value) ? 'selected="selected' : ''; ?>"><?php echo $name; ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="position" id="input-position" class="form-control">
                <?php foreach ($position_values as $value => $name) { ?>
                <option value="<?php echo $value; ?>" <?php echo ($position == $value) ? 'selected="selected' : ''; ?>"><?php echo $name; ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-article-layout"><?php echo $entry_article_layout; ?></label>
            <div class="col-sm-10">
              <select name="article_layout" id="input-article-layout" class="form-control">
                <?php foreach ($article_layout_values as $value => $name) { ?>
                <option value="<?php echo $value; ?>" <?php echo ($article_layout == $value) ? 'selected="selected' : ''; ?>"><?php echo $name; ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
...
function autoslectfeatured(){
	$('input[name=\'article\']').autocomplete({
		source: function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/module/boss_blogfeatured/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
				dataType: 'json',
