...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-boss-testimonial" class="form-horizontal">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" ><?php echo $entry_row; ?></label>
        <div class="col-sm-10">
          <input type="text" name="boss_testimonial_module[row]" value="<?php echo isset($modules['row'])?$modules['row']:1; ?>" placeholder="<?php echo $entry_row; ?>" class="form-control" />
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-2 control-label" ><?php echo $entry_perrow; ?></label>
        <div class="col-sm-10">
          <input type="text" name="boss_testimonial_module[per_row]" value="<?php echo isset($modules['per_row'])?$modules['per_row']:3; ?>" placeholder="<?php echo $entry_perrow; ?>" class="form-control" />
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="row">
            <div class="col-sm-6">
              <input type="text" name="boss_testimonial_module[width]" value="<?php echo isset($modules['width'])?$modules['width']:''; ?>" placeholder="<?php echo $entry_width; ?>"  class="form-control" />
            </div>
            <div class="col-sm-6">
              <input type="text" name="boss_testimonial_module[height]" value="<?php echo isset($modules['height'])?$modules['height']:''; ?>" placeholder="<?php echo $entry_height; ?>"  class="form-control" />
            </div>
          </div>
        </div>
      </div>
