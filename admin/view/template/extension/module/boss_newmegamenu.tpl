						...
						<li id="menuorder_<?php echo $menu['menu_id'] ?>" class="parent">
							<div class="menu-title">
								...
								<div class="bt-quick-access">
									...
									<a onclick="addMenu('<?php echo $menu['menu_id'] ?>','<?php echo $module_id; ?>');"><i class="fa fa-pencil"></i></a>
									<i class="fa fa-minus-circle" onclick="deleteMenu('<?php echo $menu['menu_id'] ?>','<?php echo $module_id ?>');"></i>
								</div>
							</div>
									...
									<?php foreach($menurow as $row){ ?>
										<li id="roworder_<?php echo $row['row_id'] ?>" class="sub-row">
												...
												<ul class="bt-menu-column" style="margin-left: -40px;">
													...
													<li class="col-<?php echo $column['num_column']; ?>" id="columnorder_<?php echo $column['column_id'] ?>">
														...
														<div class="bt-columnquick-access">
															<a onclick="addMenuColumn('<?php echo $row['row_id'] ?>','<?php echo $column['column_id'] ?>','<?php echo $module_id ?>');"><i class="fa fa-pencil"></i></a>
															
															<i class="fa fa-minus-circle" onclick="deleteMenuColumn('<?php echo $column['column_id'] ?>','<?php echo $module_id ?>');"></i>
											...
											<div class="bt-rowquick-access">
												...
												<a onclick="addMenuRow('<?php echo $menu['menu_id'] ?>','<?php echo $row['row_id'] ?>','<?php echo $module_id ?>');"><i class="fa fa-pencil"></i></a>
												<i class="fa fa-minus-circle" onclick="deleteMenuRow('<?php echo $row['row_id'] ?>','<?php echo $module_id ?>');"></i>
											</div>
										</li>
									<?php } ?>
...
$(document).ready(function(){ 
	...
	$(function() {
		$("#menusetting ul").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			$.post("index.php?route=extension/module/boss_newmegamenu/updateSortMenu&token=<?php echo $token; ?>", order, function(theResponse){
		...
		$("#menusetting ul ul.bt-menu-row").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			$.post("index.php?route=extension/module/boss_newmegamenu/updateSortRow&token=<?php echo $token; ?>", roworder, function(theResponse){
				$("#success").html(theResponse);
				$("#success").slideDown('slow');
				slideout();
			});
		...
		$("#menusetting ul ul.bt-menu-column").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			$.post("index.php?route=extension/module/boss_newmegamenu/updateSortColumn&token=<?php echo $token; ?>", columnorder, function(theResponse){
				$("#success").html(theResponse);
				$("#success").slideDown('slow');
				slideout();
			});
...
function addMenu(id,module_id){	
	$.ajax({
		url: 'index.php?route=extension/module/boss_newmegamenu/addMenu&token=<?php echo $token; ?>&module_id='+module_id+'&menu_id='+id,
		dataType: 'json',
		beforeSend: function() {
...
function addMenuRow(menu_id,row_id,module_id){
	$.ajax({
		url: 'index.php?route=extension/module/boss_newmegamenu/addMenuRow&token=<?php echo $token; ?>&module_id='+module_id+'&row_id='+row_id,
		dataType: 'json',
		beforeSend: function() {
			$('.loading').html('<span class="wait">&nbsp;<img src="../admin/view/image/loading.gif" alt="" /></span>');
		},		
...
function addMenuColumn(row_id,column_id,module_id){
	$.ajax({
		url: 'index.php?route=extension/module/boss_newmegamenu/addMenuColumn&token=<?php echo $token; ?>&module_id='+module_id+'&column_id='+column_id+'&row_id='+row_id,
		dataType: 'json',
		beforeSend: function() {
			$('.loading').html('<span class="wait">&nbsp;<img src="../admin/view/image/loading.gif" alt="" /></span>');
		},		
...
function saveMenu(id,module_id){
	$.ajax({
		url: 'index.php?route=extension/module/boss_newmegamenu/saveMenu&token=<?php echo $token; ?>&module_id='+module_id+'&menu_id='+id,
		type: 'post',
...
function saveMenuRow(menu_id,row_id,module_id){
	$.ajax({
		url: 'index.php?route=extension/module/boss_newmegamenu/saveMenuRow&token=<?php echo $token; ?>&module_id='+module_id+'&menu_id='+menu_id+'&row_id='+row_id,
		type: 'post',
...
function saveMenuColumn(row_id,column_id,module_id){
	$.ajax({
		url: 'index.php?route=extension/module/boss_newmegamenu/saveMenuColumn&token=<?php echo $token; ?>&module_id='+module_id+'&row_id='+row_id+'&column_id='+column_id,
		type: 'post',
...
function deleteMenu(id,module_id){
	if (!confirm('<?php echo $text_confirm; ?>')) {
		...
		$.ajax({
			url: 'index.php?route=extension/module/boss_newmegamenu/deleteMenu&token=<?php echo $token; ?>&module_id='+module_id+'&menu_id='+id,
			async:false,
			type: 'post',
			dataType: 'json',
			success: function(json) {
...
function deleteMenuRow(id,module_id){
	if (!confirm('<?php echo $text_confirm; ?>')) {
		...
		$.ajax({
			url: 'index.php?route=extension/module/boss_newmegamenu/deleteMenuRow&token=<?php echo $token; ?>&module_id='+module_id+'&row_id='+id,
			async:false,
			type: 'post',
			dataType: 'json',
			success: function(json) {
...
function deleteMenuColumn(id,module_id){
	if (!confirm('<?php echo $text_confirm; ?>')) {
		...
		$.ajax({
			url: 'index.php?route=extension/module/boss_newmegamenu/deleteMenuColumn&token=<?php echo $token; ?>&module_id='+module_id+'&column_id='+id,
			async:false,
			type: 'post',
			dataType: 'json',
			success: function(json) {
