				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sliderform" class="form-horizontal">
					...
					<div class="bt-slide-prev form-group" style="clear:both;">
						...
						<div id="caption_<?php echo $caption_main_row; ?>" class="caption tp-caption <?php echo isset($caption['class_css']) ? $caption['class_css'] : 'big_white';?> ui-widget ui-draggable" onclick="showCaption(<?php echo $caption_main_row; ?>)" style="top:<?php echo isset($caption['datay']) ? $caption['datay'] : '100';?>px;left:<?php echo isset($caption['datax']) ? $caption['datax'] : '100';?>px;position:absolute;">
							...
							<?php } ?>
							<?php }else{?>
							<?php echo html_entity_decode(isset($caption['text_caption'][$config_lang]) ? $caption['text_caption'][$config_lang] : 'Text Example '.$caption_main_row,ENT_QUOTES, 'UTF-8');?>
							<?php } ?>
						</div>
					...
					<div class="bt-noaccordion">
						<table class="table table-striped table-bordered table-hover">
							...
							<tr><td><label><?php echo $text_text; ?></label></td><td class="left">
								<?php foreach ($languages as $language) { ?><textarea <?php if($config_lang==$language['language_id']){ ?> oninput="changeTextCaption(<?php echo $caption_row; ?>,this.value)" <?php } ?> style="width:90%; height:60px;" name="caption[<?php echo $caption_row; ?>][text_caption][<?php echo $language['language_id']; ?>]"><?php echo isset($caption['text_caption'][$config_lang]) ? $caption['text_caption'][$config_lang] : 'Text Example '.$caption_row;?></textarea> <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /><br /><?php } ?>
							</td></tr>
							<?php } ?>
...
function addCaption(type){
	...
	if(type=='text'){
		html += '  <tr><td><label><?php echo $text_text; ?></label></td><td class="left"><?php foreach ($languages as $language) { ?><textarea <?php if($language['language_id']==$language['language_id']){ ?> oninput="changeTextCaption('+caption_row+',this.value)" <?php } ?> style="width:90%; height:60px;" name="caption['+caption_row+'][text_caption][<?php echo $language['language_id']; ?>]">Text Example '+caption_row+'</textarea> <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /><br /><?php } ?></td></tr> ';
	}else if(type=='image'){
...
html +='    </select></td></tr>';
	...
	html +='   <div class="bt-noaccordion">';
	html +='  <table class="table table-striped table-bordered table-hover">';
	html +='  <tr><td><label class="control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $text_data_speed_des;?>" ><?php echo $text_data_speed;?></span></label></td><td class="left"><input type="text" name="caption['+caption_row+'][dataspeed]" value="500" class="form-control" /></td></tr>';
	...
	html +=' <tr><td><label class="control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $text_data_end_des;?>" ><?php echo $text_data_end;?></span></label></td><td class="left"><input type="text" name="caption['+caption_row+'][dataend]" value="5000" class="form-control" /></td></tr>';

	html +=' <tr><td><label class="control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $text_data_after_speed_des;?>" ><?php echo $text_data_after_speed;?></span></label></td><td class="left"><input type="text" name="caption['+caption_row+'][dataafterspeed]" value="1000" class="form-control" /></td></tr>';
...
function addVideo(){
	$.ajax({
		url: 'index.php?route=extension/module/boss_revolutionslider/addVideo&token=<?php echo $token; ?>',
		dataType: 'json',
		beforeSend: function() {
