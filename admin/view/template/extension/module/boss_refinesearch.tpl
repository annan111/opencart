          ...
          <table class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="left"><?php echo 'Show under product'; ?></td>
                <td></td>
              </tr>
            </thead>
            <tbody class="boss_content">
              ...
              <tr>
                ...
                <td class="left"><select name="boss_refinesearch_module[<?php echo $filter['filter_group_id'];?>][display]" class="form-control">
                ...
                <td class="left"><select name="boss_refinesearch_module[<?php echo $filter['filter_group_id'];?>][under]" class="form-control">
