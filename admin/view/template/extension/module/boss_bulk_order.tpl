									...
									<table class="table">
										...
										<tr>
											...
											<td>
												...
												<input class="form-control"  data-size="small" type="checkbox" name="boss_bulk_order[option][<?php echo $option['option_id']; ?>]" value="<?php echo $option['option_id']; ?>" checked="checked" />
												<?php } else { ?>
												<input class="form-control"  data-size="small" type="checkbox" name="boss_bulk_order[option][<?php echo $option['option_id']; ?>]" value="<?php echo $option['option_id']; ?>" />
												<?php } ?>
											</td>
										</tr>
										<?php } ?>
