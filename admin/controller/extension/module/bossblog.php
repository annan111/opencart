...
class ControllerExtensionModuleBossBlog extends Controller {
	...
	public function install() {
        ...
        $data = array(
			'bossblog_name'                  =>'Blog',
			'bossblog_limit'             	=>5,
			'bossblog_admin_limit'           =>5,
			'bossblog_comment_status'        =>1,
			'bossblog_approval_status'       =>0,
			'bossblog_image_category_width' 	=>880,
			'bossblog_image_category_height' =>295,
			'bossblog_image_article_width'   =>420,
			'bossblog_image_article_height'  =>300,
			'bossblog_image_title_width'  	=>98,
			'bossblog_image_title_height'  	=>70,
			'bossblog_image_related_width'   =>271,
			'bossblog_image_related_height'  =>198,                   
		);
