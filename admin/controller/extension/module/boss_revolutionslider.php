...
class ControllerExtensionModuleBossRevolutionSlider extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('marketplace/extension', 'token=' . $this->session->data['token'] . '&type=module', 'SSL'),
			'separator' => ' :: '
		);

		$data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('extension/module/boss_revolutionslider', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->link('extension/module/boss_revolutionslider', 'token=' . $this->session->data['token'], 'SSL');

		$data['cancel'] = $this->url->link('marketplace/extension', 'token=' . $this->session->data['token'] . '&type=module', 'SSL');

		$data['modulesetting'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'token=' . $this->session->data['token'], 'SSL');

		$data['slider_list'] = $this->url->link('extension/module/boss_revolutionslider/sliderlist', 'token=' . $this->session->data['token'], 'SSL');
		...
		if(!empty($module_info)){
			...
			$data['slider'] = array(
				...
				'edit_link' => $this->url->link('extension/module/boss_revolutionslider/sliderlist', 'token=' . $this->session->data['token'] . '&slider_id=' . $module_info['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL'),
				'setting_link' => $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'token=' . $this->session->data['token'] . '&slider_id=' . $module_info['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL'),
				'total' => $total_slide
			);
	...
	public function moduleSetting(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (!isset($this->request->get['module_id'])) {
				...
				$this->response->redirect($this->url->link('marketplace/extension', 'token=' . $this->session->data['token'] . '&type=module', 'SSL'));
			} else {
				...
				$this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('extension/module/boss_revolutionslider', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL'));
			}
		}
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'token=' . $this->session->data['token'].'&slider_id='.$slider_id, 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'token=' . $this->session->data['token'].'&slider_id='.$slider_id.'&module_id='.$this->request->get['module_id'], 'SSL');
		}

		if (!isset($this->request->get['module_id'])) {
			$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider', 'token=' . $this->session->data['token'].'&module_id=' . $this->request->get['module_id'], 'SSL');
		}
	...
	public function sliderlist(){
		...
		$data['action'] = $this->url->link('extension/module/boss_revolutionslider/setting', 'token=' . $this->session->data['token'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider', 'token=' . $this->session->data['token'].'&module_id=' . $this->request->get['module_id'], 'SSL');

		$data['slider_form'] = $this->url->link('extension/module/boss_revolutionslider/sliderform', 'token=' . $this->session->data['token'], 'SSL');

		$data['modulesetting'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'token=' . $this->session->data['token'].'&slider_id='.$this->request->get['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL');

		$data['new_slide'] = $this->url->link('extension/module/boss_revolutionslider/sliderform', 'token=' . $this->session->data['token'].'&slider_id='.$this->request->get['slider_id'].'&slide_id=0'.'&module_id=' . $this->request->get['module_id'], 'SSL');
		...
		foreach($slides as $slide){
			$data['slides'][] = array(
				...
				'edit_link' => $this->url->link('extension/module/boss_revolutionslider/sliderform', 'token=' . $this->session->data['token'] . '&slide_id=' . $slide['id'].'&slider_id=' . $slide['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL'),
				'delete_link' => $this->url->link('extension/module/boss_revolutionslider/deleteSlide', 'token=' . $this->session->data['token'] . '&slide_id=' . $slide['id'].'&module_id=' . $this->request->get['module_id'], 'SSL')
			);
		}
	...
	public function sliderform(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/boss_revolutionslider/sliderlist', 'token=' . $this->session->data['token'].'&slider_id='.$slider_id.'&module_id=' . $this->request->get['module_id'], 'SSL'));
		}
		...
		$data['action'] = $this->url->link('extension/module/boss_revolutionslider/sliderForm', 'token=' . $this->session->data['token'].'&slide_id='.$slide_id.'&slider_id='.$slider_id.'&module_id=' . $this->request->get['module_id'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider/sliderlist', 'token=' . $this->session->data['token'].'&slider_id='.$slider_id.'&module_id=' . $this->request->get['module_id'], 'SSL');
	...
	public function deleteSlide(){
		...
		if (isset($this->request->get['slide_id']) && !empty($this->request->get['slide_id'])) {
			...
			$json['redirect'] = $this->url->link('extension/module/boss_revolutionslider/sliderlist&token=' . $this->session->data['token']. '&slider_id=' . $this->request->get['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL');
		}
