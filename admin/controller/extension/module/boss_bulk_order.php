...
class ControllerExtensionModuleBossBulkOrder extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/boss_bulk_order', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/boss_bulk_order', 'token=' . $this->session->data['token'], true);
