...
class ControllerExtensionBossthemesHeader extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/bossthemes/header', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['action'] = $this->url->link('extension/bossthemes/header', 'token=' . $this->session->data['token'], 'SSL');
