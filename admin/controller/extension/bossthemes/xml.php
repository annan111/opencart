...
class ControllerExtensionBossthemesXml extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/bossthemes/xml', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	public function getList() {
		...
		$data['refresh'] = $this->url->link('extension/bossthemes/xml/refresh', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('extension/bossthemes/xml/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['modifications'][] = array(
				...
				'link'            => $result['link'],
				'enable'          => $this->url->link('extension/bossthemes/xml/enable', 'token=' . $this->session->data['token'] . '&modification_id=' . $result['modification_id'], true),
				'disable'         => $this->url->link('extension/bossthemes/xml/disable', 'token=' . $this->session->data['token'] . '&modification_id=' . $result['modification_id'], true),
		...
		$data['sort_name'] = $this->url->link('extension/bossthemes/xml', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_author'] = $this->url->link('extension/bossthemes/xml', 'token=' . $this->session->data['token'] . '&sort=author' . $url, true);
		$data['sort_version'] = $this->url->link('extension/bossthemes/xml', 'token=' . $this->session->data['token'] . '&sort=version' . $url, true);
		$data['sort_status'] = $this->url->link('extension/bossthemes/xml', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
		$data['sort_date_added'] = $this->url->link('extension/bossthemes/xml', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, true);
		...
		$pagination->url = $this->url->link('extension/bossthemes/xml', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$data['clear_log'] = $this->url->link('extension/bossthemes/xml/clearlog', 'token=' . $this->session->data['token'], true);
			...
			if (strrchr($this->request->files['file']['name'], '.') == '.xml') {
				...
				if (file_exists($file)) {
					$json['step'][] = array(
						...
						'url'  => str_replace('&amp;', '&', $this->url->link('extension/bossthemes/xml/xml', 'token=' . $this->session->data['token'], true)),
						'path' => $path
					);
					...
					$json['step'][] = array(
						...
						'url'  => str_replace('&amp;', '&', $this->url->link('extension/bossthemes/xml/remove', 'token=' . $this->session->data['token'], true)),
						'path' => $path
					);
				} else {
