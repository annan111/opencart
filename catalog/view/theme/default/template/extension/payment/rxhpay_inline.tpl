...
<script type="text/javascript"><!--
	...
	$("#button-confirm").bind("click",function(){
		...
		$.ajax({
			type: "GET",
			url: "index.php?route=extension/payment/rxhpay_inline/confirm",
			beforeSend: function() {
			...
			success: function()
			{
				$.ajax({
					type: "GET",
					dataType: "json",
					url:"index.php?route=extension/payment/rxhpay_inline/arguments_confirmed",
					success: function(data){
						if(data.msg){
							location = 'index.php?route=extension/payment/rxhpay_inline/torxhpay_inline';
						}else{
							alert(data);
