...
<script type="text/javascript"><!--
	...
	$("#button-confirm").bind("click",function(){
		...
		$.ajax({
			type: "GET",
			url: "index.php?route=extension/payment/rxhpay/confirm",
			beforeSend: function() {
			...
			success: function()
			{
				$.ajax({
					type: "GET",
					dataType: "json",
					url:"index.php?route=extension/payment/rxhpay/arguments_confirmed",
					success: function(data){
						if(data.msg){
							$.ajax({
								type: 'GET',
								url: 'index.php?route=extension/payment/rxhpay/torxhpay',
								dataType: 'json',
								success: function(data){
									var form = $('<form></form>');
