...
<link href="catalog/view/theme/<?php echo $template_directory; ?>/stylesheet/bossthemes/slick-theme.css" type="text/css" rel="stylesheet" media="screen" />
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div itemscope itemtype="http://schema.org/Product">
        <div class="row product-info product-2">
          <?php if ($column_left || $column_right) { ?>
          <?php $class = 'col-sm-6'; ?>
          <?php } else { ?>
          <?php $class = 'col-sm-7'; ?>
