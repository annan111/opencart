  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div itemscope itemtype="http://schema.org/Product">
        <div class="row product-info product-6">
          <?php if ($thumb || $images) { ?>
          <?php $class = 'col-lg-3 col-md-3 hidden-sm hidden-xs'; ?>
          <?php } else { ?>
          <?php $class = 'col-lg-6 col-md-6 hidden-sm hidden-xs'; ?>
          <?php } ?>
          ...
          <?php } ?>
          <?php if ($thumb || $images) { ?>
          <?php $class = 'col-lg-3 col-md-3 col-sm-5'; ?>
          <?php } else { ?>
          <?php $class = 'col-lg-6 col-md-6 col-sm-12'; ?>
          <?php } ?>
          <div class="<?php echo $class; ?>">
            <div id="product">
                ...
                <div id="input-option<?php echo $option['product_option_id']; ?>">
                  ...
                  <div class="radio <?php echo ($option_value['image']) ? 'radio-inline has-image' : ''; ?>">
                    <label>
                      ...
                      <?php } ?>
                      <span <?php echo ($option_value['image']) ? 'class="hidden"' : ''; ?>> <?php echo $option_value['name']; ?>
                      <?php if ($option_value['price']) { ?>
                      (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
                      <?php } ?>
                      </span> </label>
...
<script type="text/javascript">
$(function() {
	$('.info-sticky').hcSticky({
		top: 65,
		stickTo: '.product-info',
		followScroll: false,
		offResolutions: -768
	});
