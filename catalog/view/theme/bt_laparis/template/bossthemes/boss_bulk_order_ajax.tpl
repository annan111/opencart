  ...
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr id="add_to_cart<?php echo $product['product_id'] ?>">
        ...
        <?php } ?>
        <?php if(!empty($option_id_show)) { ?>
        <?php $flag_array = array(); ?>
        <?php $flag_count = count($product['options']); ?>
        <?php foreach($option_id_show as $key => $option_show){ ?>
        <?php $flag = 0;?>
        <td><?php while($flag < $flag_count){ ?>
          <?php $option = isset($product['options'][$flag])?$product['options'][$flag]:''; ?>
          <?php if(!empty($option) && $option['option_id'] == $option_show['option_id'] && !in_array($option['option_id'], $flag_array)) { ?>
          <?php $flag_array[] = $option['option_id']; ?>
          <?php $flag = $flag_count; ?>
        ...
        <td class="cart"><div class="input-group quantity">
            <span class="input-group-btn"><button onclick="changeQty('<?php echo 'select-number'.$product['product_id'];?>',0,'<?php echo $product['minimum']; ?>'); return false;" class="btn btn-default decrease"><i class="fa fa-minus"></i></button></span>
            ...
            <span class="input-group-btn"><button onclick="changeQty('<?php echo 'select-number'.$product['product_id'];?>',1,'<?php echo $product['minimum']; ?>'); return false;" class="btn btn-default increase"><i class="fa fa-plus"></i></button></span>
          </div>
