    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <form id="boss_bulk_order">
        ...
        <div class="col-sm-4 search-price">
          <div class="form-group">
            <p><?php echo $text_price_range;?></p>
            <div id="slider-range"></div>
            <p>
              <label for="amount"><?php echo $text_price;?></label>
              <input type="text" id="amount" readonly style="border:0; color:#f6931f; font-weight:bold;">
            </p>
            <input type="hidden" id="b_filter_price_min" name="fmin" data-min="<?php echo !empty($b_filter_price_min)?$b_filter_price_min:1;?>" data-max="<?php echo !empty($b_filter_price_max)?$b_filter_price_max:1200;?>" data-step="1" value="<?php echo !empty($b_filter_price_min)?$b_filter_price_min:1;?>" />
      ...
      <div class="b_bulk_order_ajax">
        <div class="b_bulk_table">
          <table class="table table-bordered">
            <thead>
              <tr>
                <td class="text-center image"><?php echo $entry_image; ?></td>
                <?php if($search_product){ ?>
            ...
            <tbody>
              ...
              <tr id="add_to_cart<?php echo $product['product_id'] ?>">
                <td class="text-center image"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb'] ?>" title="<?php echo $product['name'] ?>" alt="<?php echo $product['name'] ?>" /></a></td>
                <?php if($search_product){ ?>
                <td class="text-left name"><a title="<?php echo $product['name'] ?>" href="<?php echo $product['href']; ?>"><?php echo $product['name'] ?></a></td>
                <?php } ?>
                <?php if($search_model){ ?>
                ...
                <td class="cart"><div class="input-group quantity"> <span class="input-group-btn">
                    <button onclick="changeQty('<?php echo 'select-number'.$product['product_id'];?>',0,'<?php echo $product['minimum']; ?>'); return false;" class="btn btn-default decrease"><i class="fa fa-minus"></i></button>
                    </span>
                    <input id="select-number<?php echo $product['product_id']; ?>" type="text" name="quantity" value="<?php echo $product['minimum']; ?>" size="1" class="form-control text-center" />
                    <span class="input-group-btn">
                    <button onclick="changeQty('<?php echo 'select-number'.$product['product_id'];?>',1,'<?php echo $product['minimum']; ?>'); return false;" class="btn btn-default increase"><i class="fa fa-plus"></i></button>
                    </span> </div>
                    <button type="button" onclick="addto('select-number<?php echo $product['product_id']; ?>', '<?php echo $product['product_id']; ?>');" class="btn btn-primary btn-block"><i class="lnr lnr-cart"></i></button>
...
$(function() {
	...
	slide: function( event, ui ) {
		...
		$( "#amount" ).val( "<?php echo $symbolLeft;?>" + ui.values[ 0 ] + " - <?php echo $symbolLeft;?>" + ui.values[ 1 ] );
		<?php }else{ ?>
		$( "#amount" ).val( ui.values[ 0 ] + "<?php echo $symbolRight;?> - " + ui.values[ 1 ] + "<?php echo $symbolRight;?>" );
		<?php } ?>
