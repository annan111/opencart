		...
		<div class="tp-banner tp-banner<?php echo $module;?>" >
			<ul>	<!-- SLIDE  -->
				...
				<div class="tp-caption <?php echo isset($caption['class_css']) ? $caption['class_css'] : '';?> <?php echo isset($caption['incom_animation'])?$caption['incom_animation']:'';?> <?php echo isset($caption['outgo_animation'])?$caption['outgo_animation']:'';?> rs-parallaxlevel-0"
					 ...
					 style="z-index: 2;"><?php if(isset($caption['type_caption'])&&($caption['type_caption']=='image')){?><img src="catalog/view/theme/<?php echo $config_teamplate; ?>/image/dummy.png" alt="" data-lazyload="image/<?php echo $caption['image_caption']; ?>" /><?php }elseif(isset($caption['type_caption'])&&($caption['type_caption']=='video')){?>
					...
					<?php } ?>
					<?php }else{?>
					<?php echo html_entity_decode(isset($caption['text_caption'][$config_language]) ? $caption['text_caption'][$config_language] : '',ENT_QUOTES, 'UTF-8');?>
					<?php } ?>
				</div>
				<?php $i++; } } ?>
				</li>
