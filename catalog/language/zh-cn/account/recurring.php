...
$_['text_recurring_detail']   = '分期详情';
$_['text_order_recurring_id'] = '分期ID：';
$_['text_date_added']         = '添加时间：';
$_['text_status']             = '状态';
...
$_['text_empty']              = '没有找到分期付款！';
$_['text_error']              = '没有找到分期付款！';

$_['text_cancelled'] = '分期款项已被取消';
...
$_['column_product']            = '商品';
$_['column_action']             = '操作';
$_['column_recurring_id']       = '配置文件 ID';

// Error
$_['error_not_cancelled'] = '错误: %s';
$_['error_not_found'] = '无法取消分期款项';
...
//$_['button_return'] = '返回';
//$_['text_empty_transactions'] = '这个分期款项的配置文件没有交易记录';
...
/*$_['text_recurring_detail'] = '分期款项详细信息';
$_['text_recurring_id'] = '配置文件的 ID： ';
