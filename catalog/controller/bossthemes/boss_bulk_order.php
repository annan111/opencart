...
class ControllerBossthemesBossBulkOrder extends Controller {
	public function index() {
		...
		if(isset($setting['status']) && $setting['status']){
			...
			if (file_exists('catalog/view/theme/' . $this->config->get($this->config->get('config_theme') . '_directory') . '/stylesheet/bossthemes/boss_bulk_order.css')) {
				$this->document->addStyle('catalog/view/theme/' . $this->config->get($this->config->get('config_theme') . '_directory') . '/stylesheet/bossthemes/boss_bulk_order.css');
			} else {
