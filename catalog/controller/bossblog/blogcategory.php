	...
	public function index() {
	   ...
	   if (isset($this->request->get['page'])) {
		...
		if (isset($this->request->get['limit'])) {
			...
			$limit = $this->config->get('bossblog_limit');
		}
		...
		if ($blogcategory_info) {
			...
			if ($blogcategory_info['image']) {
				$data['thumb'] = $this->model_tool_image->resize($blogcategory_info['image'], $this->config->get('bossblog_image_article_width'), $this->config->get('bossblog_image_article_height'));
			} else {
				$data['thumb'] = '';
			}
		   ...
		   $url = '';
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get($this->config->get('config_theme') . '_directory') . '/template/error/not_found.tpl')) {
				$this->template = $this->config->get($this->config->get('config_theme') . '_directory') . '/template/error/not_found.tpl';
			} else {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get($this->config->get('config_theme') . '_directory') . '/template/error/not_found.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get($this->config->get('config_theme') . '_directory') . '/template/error/not_found.tpl', $data));
			} else {
