...
class ControllerBossblogArticle extends Controller {
	...
	public function index() { 
		...
		$comment_status = $this->config->get('bossblog_comment_status');
		
		$approval_status = $this->config->get('bossblog_approval_status');
		...
		if ($article_info) {
			...
			$data['thumb'] = $this->model_tool_image->resize($article_info['image'], $this->config->get('bossblog_image_article_width'), $this->config->get('bossblog_image_article_height'));
